...
public:
	...
	virtual void onAttach() override
	{
		...
		player_score_text = wgl::Text(font, std::to_string(player.score));
		player_score_text.shader = wgl::Shader("../resources/shaders/text.vert", "../resources/shaders/text.frag");
		...
		opp_score_text = wgl::Text(font, std::to_string(opponent.score));
		opp_score_text.shader = wgl::Shader("../resources/shaders/text.vert", "../resources/shaders/text.frag");
