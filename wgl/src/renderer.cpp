...
Renderer::Renderer(ref<Camera> camera) : camera(camera), lightPos(glm::vec3(0.0, 0.0, 50.0))
{
}
...
void Renderer::drawEntity(ref<Entity> entity)
{
	entity->shader->use();
...
void Renderer::drawText(ref<Text> text)
{
	text->shader->use();
